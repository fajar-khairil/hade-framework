...
type
  ...
  public
    ...
    function GetInternalList : PHashArray;
...
function TStringHashMap.IterateNode(ANode: PHashNode; AUserData: PUserData;
...
function TStringHashMap.IterateMethodNode(ANode: PHashNode;
  AUserData: PUserData; AIterateMethod: TIterateMethod): Boolean;
begin
  if ANode <> nil then
  begin
...
procedure TStringHashMap.NodeIterate(ANode: PPHashNode; AUserData: PUserData;
...
function TStringHashMap.GetData(const S: string): PData;
var
  PPN: PPHashNode;
begin
  PPN := FindNode(S);
...
procedure TStringHashMap.SetData(const S: string; P: PData);
var
  PPN: PPHashNode;
begin
  PPN := FindNode(S);
...
function TStringHashMap.Remove(const S: string): PData;
var
  PPN: PPHashNode;
begin
  PPN := FindNode(S);
...
procedure TStringHashMap.IterateMethod(AUserData: PUserData;
...
procedure TStringHashMap.Iterate(AUserData: PUserData;
...
function TStringHashMap.GetInternalList: PHashArray;
begin
  Result := FList;
end;
